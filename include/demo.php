                ...
                <section class="island" id="buttons-example">
                    ...
                    <div class="line btmspc">
                        <a href="#" class="button secondary brdr brdr-primary iconfont caution">Secondary Button</a>
                        <a href="#" class="button secondary brdr brdr-primary iconfont-right money">Secondary Button</a>
